...
const Banner = () => {
    return (
        <div className='bg-cover h-screen' style={{ backgroundImage: `url(${bgBanner})` }}>
            <div className='min-w-xs lg:w-3/4 bg-white h-1/2 relative top-40 left-12 lg:flex'>
                ...
                <div className=' bg-base-100 h-full sm:w-full lg:w-1/2 font-bold flex flex-col justify-center pl-12 text-rose-600'>
